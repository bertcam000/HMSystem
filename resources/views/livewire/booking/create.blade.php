...
<section class="grid lg:grid-cols-5 gap-5">
    <div @click.away="addBooking = false" class="col-span-3 bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        ...
        <form class="space-y-4 mt-4" wire:submit.prevent="saveReservation" @click.away="addBooking = ''">
            <div>
                <x-select
                    label="Select Guest"
    ...
    <div class="col-span-2 bg-white text-slate-800 rounded-3xl shadow-sm border border-slate-200 p-6 md:p-7 w-full">
        ...
        <button class="mt-6 w-full rounded-2xl bg-slate-900 text-white font-semibold py-3.5 hover:bg-slate-700 transition">
            Proceed Payment
        </button>
