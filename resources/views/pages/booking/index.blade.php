<x-layouts.layout>
    ...
    <section class="space-y-7 p-3 rounded-xl" x-data="{ addBooking: false }">
        ...
        <div class="flex justify-between items-center">
            ...
            <button @click="addBooking = true" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primaryDark transition-colors text-sm font-medium">
            + Add Room
            </button>
        </div>
              ...
              <table id="qr-print-area" class="w-full text-sm text-left rtl:text-right text-body">
                  <thead class="text-sm text-body bg-neutral-secondary-soft border-b rounded-base border-default">
                    <div class="text-end px-5 py-2  print-date">{{ now()->format('M d, Y') }}</div>
                      <tr class=" text-gray-600 text-left">
                          ...
                          <th scope="col" class="px-6 py-1 font-semibold">AMOUNT</th>
                  ...
                  <tbody>
                      ...
                      <tr class="bg-neutral-primary border-b border-default hover:bg-gray-50" x-data="{ open: false, dl: false }">
                        <th scope="row" class="px-6 py-4 font-medium text-heading whitespace-nowrap">awe</th>
                        <td class="px-6 py-4">
                            <h1 class=" font-medium">John Snow</h1>
                            <p class="text-gray-500 text-sm">jonb@gmail.com</p>
                        </td>
                        <td class="px-6 py-4">Room 101</td>
                        <td class="px-6 py-4 text-gray-500">2026-03-18</td>
                        <td class="px-6 py-4 text-gray-500">2026-03-20</td>
